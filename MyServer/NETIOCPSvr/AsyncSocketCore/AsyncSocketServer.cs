...
namespace MyServer
{
    public class AsyncSocketServer
    {
        ...
        public DownloadSocketProtocolMgr DownloadSocketProtocolMgr { get { return m_downloadSocketProtocolManager; } }
        ...
        public AsyncSocketServer(int numConnections)
        {
            ...
            m_logOutputSocketProtocolManager = new LogOutputSocketProtocolMgr();
            m_uploadSocketProtocolManager = new UploadSocketProtocolMgr();
            m_downloadSocketProtocolManager = new DownloadSocketProtocolMgr();
        }
